                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-4 md:p-5 text-center">
                                ...
                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Anda
                                    yakin ingin menghapus data: {{ $data->nama }} - {{ $data->spesialis }}?</h3>
                                <form action="/datadokter-destroy/{{ $data->id_dokter }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
                                ...
                                <button type="button"
                                    ...
                                    data-modal-hide="popup-modal-{{ $data->id_dokter }}">No, cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
